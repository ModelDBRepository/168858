...
./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_aug3aP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-aug3a" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=Aug3a-all \
    | parallel --eta >> NumericalResults/parameterSpace_aug3aP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_aug3cP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-aug3c" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=Aug3c-all \
    | parallel --eta >> NumericalResults/parameterSpace_aug3cP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_aug3eP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-aug3e" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=Aug3e-all \
    | parallel --eta >> NumericalResults/parameterSpace_aug3eP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_aug3fP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-aug3f" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=Aug3f-all \
    | parallel --eta >> NumericalResults/parameterSpace_aug3fP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_aug3gP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-aug3g" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=Aug3g-all \
    | parallel --eta >> NumericalResults/parameterSpace_aug3gP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_feb27nP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-feb27n" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=Feb27n-all \
    | parallel --eta >> NumericalResults/parameterSpace_feb27nP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_dec15eP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-dec15e" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=Dec15e-all \
    | parallel --eta >> NumericalResults/parameterSpace_dec15eP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_jun7dP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-jun7d" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=Jun7d-all \
    | parallel --eta >> NumericalResults/parameterSpace_jun7dP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_may3dP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-may3d" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=May3d-all \
    | parallel --eta >> NumericalResults/parameterSpace_may3dP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_may3hP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-may3h" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=May3h-all \
    | parallel --eta >> NumericalResults/parameterSpace_may3hP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_may3iP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-may3i" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=May3i-all \
    | parallel --eta >> NumericalResults/parameterSpace_may3iP2.csv


./Scripts/Python/generateParameterSpaceCommands --headers \
    > NumericalResults/parameterSpace_may3tP2.csv
./Scripts/Python/generateParameterSpaceCommands --params "customPass-may3t" \
    --gNa=60,60 --gKv=15,15 --stepSize=100 --stims=30,80,130,180,230,280,330 \
    --neurons=May3t-all \
    | parallel --eta >> NumericalResults/parameterSpace_may3tP2.csv
