...
./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-aug3a.csv
./Scripts/Python/generateComputationCommands --params "customPass-aug3a" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-aug3a.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-aug3c.csv
./Scripts/Python/generateComputationCommands --params "customPass-aug3c" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-aug3c.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-aug3e.csv
./Scripts/Python/generateComputationCommands --params "customPass-aug3e" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-aug3e.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-aug3f.csv
./Scripts/Python/generateComputationCommands --params "customPass-aug3f" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-aug3f.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-aug3g.csv
./Scripts/Python/generateComputationCommands --params "customPass-aug3g" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-aug3g.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-feb27n.csv
./Scripts/Python/generateComputationCommands --params "customPass-feb27n" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-feb27n.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-dec15e.csv
./Scripts/Python/generateComputationCommands --params "customPass-dec15e" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-dec15e.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-jun7d.csv
./Scripts/Python/generateComputationCommands --params "customPass-jun7d" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-jun7d.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-may3d.csv
./Scripts/Python/generateComputationCommands --params "customPass-may3d" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-may3d.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-may3h.csv
./Scripts/Python/generateComputationCommands --params "customPass-may3h" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-may3h.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-may3i.csv
./Scripts/Python/generateComputationCommands --params "customPass-may3i" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-may3i.csv;

./Scripts/Python/mbpap --headers > NumericalResults/mbpap-partial-spiny-may3t.csv
./Scripts/Python/generateComputationCommands --params "customPass-may3t" \
    mbpap:partial | parallel --eta \
    >> NumericalResults/mbpap-partial-spiny-may3t.csv;
